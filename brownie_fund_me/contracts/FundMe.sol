...
contract FundMe {
    ...
    AggregatorV3Interface public xtzPriceFeed;

    constructor(
        address _ethPriceFeed,
        address _maticPriceFeed,
        address _xtzPriceFeed
    ) public {
        ethPriceFeed = AggregatorV3Interface(_ethPriceFeed);
        maticPriceFeed = AggregatorV3Interface(_maticPriceFeed);
        xtzPriceFeed = AggregatorV3Interface(_xtzPriceFeed);
        owner = msg.sender;
    }
    ...
    function getXtzPrice() public view returns (uint256) {
        ...
        // );
        (, int256 answer, , , ) = xtzPriceFeed.latestRoundData();
        return uint256(answer * 10000000000);
    }
